  ...
  <div class="container-fluid">
    ...
    <div class="card-body">
     ...
     <table class="table table-dark table-bordered table-striped table-hover">
      ...
      <?php
      $no = 1;
      $tampil = mysqli_query($conn,  "SELECT * FROM departments ");
        ...
        <div class="modal fade" id="modalubah<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form method="POST" action="aksi_dep.php">
              ...
              <form method="POST" action="aksi_dep.php">
                <input type="hidden" name="id" value="<?=$data['id']?>" >
                  <div class="modal-body">
                    ...
                    <span class="text-danger"><?=$data['name']?> - <?=$data['hospital_id']?></span>
            ...
            <div class="modal-content">
              ...
              <form method="POST" action="aksi_dep.php">
                  <div class="modal-body">
                          ...
                          <div class="mb-3">
                            <label class="form-label">Hospital_id</label>
                            <input type="text" class="form-control" name="thospital_id" placeholder="Masukkan Nama RS">
                          </div>
